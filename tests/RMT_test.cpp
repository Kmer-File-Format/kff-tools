    ...
    CASE("Test a 0-Range Max Tree implementation") {
        ...
        SETUP("With pair") {
            ...
            SECTION("range_between") {
                ...
                EXPECT(rmt.range_between(PairInt(1, 1), PairInt(1, 1)) == 7u);
                EXPECT(rmt.range_between(PairInt(1, 0), PairInt(1, 3)) == 9u);
                EXPECT(rmt.range_between(PairInt(1, 3), PairInt(1, 3)) == 9u);
                EXPECT(rmt.range_between(PairInt(1, 3), PairInt(0, 5)) == 10u);
                EXPECT(rmt.range_between(PairInt(0, 5), PairInt(0, 5)) == 10u);
